export default {
  ...
  logo: "cursor-pointer",
  searchContainer:
    "hidden sm:flex bg-yellow-400 hover:bg-yellow-500 items-center h-10 rounded-md flex-grow cursor-pointer",
  searchInput:
    "p-2 h-full w-6 flex-grow flex-shrink rounded-l-md focus:outline-none",
  searchIcon: "h-12 p-4",
